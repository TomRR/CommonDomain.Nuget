...
/// </summary>
[Generator]
public class AggregateRootBaseGenerator : IIncrementalGenerator
{
        ...
        GeneratorSyntaxContext context)
    {
        ...
        foreach (AttributeSyntax attributeSyntax in attributeListSyntax.Attributes)
        {
            ...
            // filter
            if (attributeName.Contains("AggregateRoot"))
            {
...
public sealed partial class {className} : AggregateRoot<{className}Id>;";
